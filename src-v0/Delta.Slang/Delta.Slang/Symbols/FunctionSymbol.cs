...
namespace Delta.Slang.Symbols
{
    ...
    public class UnaryOperatorFunctionSymbol : FunctionSymbol, IOperatorFunctionSymbol
    {
        ...
        private static ParameterSymbol MakeParameter(TypeSymbol type) => new ParameterSymbol("operand", type);
    }
    ...
    public class BinaryOperatorFunctionSymbol : FunctionSymbol, IOperatorFunctionSymbol
    {
        ...
        private static ParameterSymbol MakeLhs(TypeSymbol type) => new ParameterSymbol("lhs", type);
        private static ParameterSymbol MakeRhs(TypeSymbol type) => new ParameterSymbol("rhs", type);
    }
}
