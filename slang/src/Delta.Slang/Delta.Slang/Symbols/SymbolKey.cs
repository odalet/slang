...
namespace Delta.Slang.Symbols
{
    public readonly struct SymbolKey : IEquatable<SymbolKey>
    {
        ...
        internal static SymbolKey FromLabel(string name) => new SymbolKey(new[] { name });
        internal static SymbolKey FromVariable(string name) => new SymbolKey(new[] { name });
        internal static SymbolKey FromType(string name) => new SymbolKey(new[] { name });
