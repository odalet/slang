...
{
    public static readonly ConversionKind None = new(exists: false, isIdentity: false, isImplicit: false);
    public static readonly ConversionKind Identity = new(exists: true, isIdentity: true, isImplicit: true);
    public static readonly ConversionKind Implicit = new(exists: true, isIdentity: false, isImplicit: true);
    public static readonly ConversionKind Explicit = new(exists: true, isIdentity: false, isImplicit: false);
