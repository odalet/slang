...
internal sealed partial class Parser
{
    ...
    public Parser(IEnumerable<Token> source)
    {
        ...
        tokens = source
            .Where(t => t.Kind is not TokenKind.Whitespace and not TokenKind.Invalid and not TokenKind.Comment)
            .ToArray();
    }
    ...
    private BlockNode ParseBlock()
    {
        ...
        while (Current.Kind is not TokenKind.CloseBrace and not TokenKind.Eof)
        {
            var startToken = Current;
